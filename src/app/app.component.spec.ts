...
describe('AppComponent', () => {
  ...
  it('should render "about" component property (hybrid expectations)', () => {
    ...
    const compiled = fixture.nativeElement as HTMLElement;
    const app = fixture.componentInstance;
    expect(compiled.querySelector('h2')?.textContent).toContain('Testing a new component variable');
    expect(compiled.querySelector('h2')?.textContent).toContain(app.about);
  });
