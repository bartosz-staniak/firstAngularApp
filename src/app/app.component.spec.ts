...
describe('AppComponent', () => {
  ...
  it('should render "about" component property (hybrid expectations)', () => {
    ...
    const compiled = fixture.nativeElement as HTMLElement;
    const app = fixture.componentInstance;
    expect(compiled.querySelector('span')?.textContent).toContain('Resting a new component variable');
    expect(compiled.querySelector('h1')?.textContent).toContain(app.about);
  });
